  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_45_582}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_45_585}
      />
      <View style={styles.View_45_557}>
        <View style={styles.View_45_558}>
          <Text style={styles.Text_45_558}>Welcome</Text>
        </View>
        <View style={styles.View_45_559}>
          <Text style={styles.Text_45_559}>TROY HALL</Text>
        </View>
        <View style={styles.View_45_560}>
          <Text style={styles.Text_45_560}>Your DashTags</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_45_561}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_45_562}
        />
        <ImageBackground
          source={{
            uri:
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_45_469}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_45_472}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_45_473}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_45_474}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_45_488}
      />
      <View style={styles.View_45_489} />
      <View style={styles.View_45_490} />
      <View style={styles.View_45_491}>
        <View style={styles.View_45_492}>
          <View style={styles.View_45_493} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f1a2/43e1/6a117e6f23042c3c3e1d018a34beb3bd"
            }}
            style={styles.ImageBackground_45_494}
          />
        </View>
        <ImageBackground
          source={{
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_45_502}
      />
      <View style={styles.View_45_503}>
        <Text style={styles.Text_45_503}>Insurance</Text>
      </View>
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5cf1/fd76/a20482ce2168e39cc84e051666ae5112"
        }}
        style={styles.ImageBackground_45_517}
      />
      <TouchableOpacity
        style={styles.TouchableOpacity_45_530}
        onPress={() =>
      ...
      >
        <ImageBackground
          ...
          style={styles.ImageBackground_45_531}
        />
        <ImageBackground
          source={{
            uri:
      ...
      <TouchableOpacity
        style={styles.TouchableOpacity_45_536}
        onPress={() =>
      ...
      >
        <ImageBackground
          ...
          style={styles.ImageBackground_45_537}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_45_538}
        />
      </TouchableOpacity>
    </ScrollView>
  )
